...
#ifndef prod2016MC_reducedNANO_EventFilters_h
#define prod2016MC_reducedNANO_EventFilters_h
...
class prod2016MC_reducedNANO_EventFilters {
public :
...
//
 ...
 //  TBranch        *b_HLT_DoubleMediumCombinedIsoPFTau35_Trk1_eta2p1_Reg;   //!
  ...
  TBranch        *b_HLT_DoubleMu4_PsiPrimeTrk_Displaced;   //!
   ...
   prod2016MC_reducedNANO_EventFilters(TTree *tree=0);
   virtual ~prod2016MC_reducedNANO_EventFilters();
...
#ifdef prod2016MC_reducedNANO_EventFilters_cxx
prod2016MC_reducedNANO_EventFilters::prod2016MC_reducedNANO_EventFilters(TTree *tree) : fChain(0) 
{
...
prod2016MC_reducedNANO_EventFilters::~prod2016MC_reducedNANO_EventFilters()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t prod2016MC_reducedNANO_EventFilters::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t prod2016MC_reducedNANO_EventFilters::LoadTree(Long64_t entry)
{
...
void prod2016MC_reducedNANO_EventFilters::Init(TTree *tree)
{
...
Bool_t prod2016MC_reducedNANO_EventFilters::Notify()
{
...
void prod2016MC_reducedNANO_EventFilters::Show(Long64_t entry)
{
...
Int_t prod2016MC_reducedNANO_EventFilters::Cut(Long64_t entry)
{
