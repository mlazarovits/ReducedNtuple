...
#ifndef prod2017MC_reducedNANO_EventFilters_h
#define prod2017MC_reducedNANO_EventFilters_h
...
class prod2017MC_reducedNANO_EventFilters {
public :
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   prod2017MC_reducedNANO_EventFilters(TTree *tree=0);
   virtual ~prod2017MC_reducedNANO_EventFilters();
...
#ifdef prod2017MC_reducedNANO_EventFilters_cxx
prod2017MC_reducedNANO_EventFilters::prod2017MC_reducedNANO_EventFilters(TTree *tree) : fChain(0) 
{
...
prod2017MC_reducedNANO_EventFilters::~prod2017MC_reducedNANO_EventFilters()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t prod2017MC_reducedNANO_EventFilters::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t prod2017MC_reducedNANO_EventFilters::LoadTree(Long64_t entry)
{
...
void prod2017MC_reducedNANO_EventFilters::Init(TTree *tree)
{
...
Bool_t prod2017MC_reducedNANO_EventFilters::Notify()
{
...
void prod2017MC_reducedNANO_EventFilters::Show(Long64_t entry)
{
...
Int_t prod2017MC_reducedNANO_EventFilters::Cut(Long64_t entry)
{
...
#endif // #ifdef prod2017MC_reducedNANO_EventFilters_cxx
